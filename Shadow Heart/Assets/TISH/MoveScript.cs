...
public class MoveScript : MonoBehaviour
{
    ...
    public void FixedUpdate()
    {
        ...
        targetRotation = Quaternion.RotateTowards(transform.rotation, targetRotation, 420 * Time.fixedDeltaTime);

        playerRb.MoveRotation(targetRotation);

        transform.Rotate(Vector3.up * Input.GetAxis("Mouse X") * cam.GetComponent<Koekie>().sensivity * Time.fixedDeltaTime);
